...
>> P(ID twin | ID twin + F twin) = P(ID twin + F twin | ID twin) * P(ID twin) / P(ID twin + F twin)
...
>> Frequentist statistics make use of observed frequencies of event occurances while Bayesian statistics use prior knowledge of conditions that are thought to be related to the occurance of an event.
